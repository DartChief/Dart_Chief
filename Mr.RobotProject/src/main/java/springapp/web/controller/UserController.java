...
//import springmvc.springapp.model.User;
...
//
//    @Autowired
//    private UserValidator springapp.validator;
//
...
//        ModelAndView springapp.model = new ModelAndView("UserForm");
//        springapp.model.addObject("user", user);
//        System.out.println("User Update");
//        return springapp.model;
//
//    }
//
...
//        springapp.validator.validate(user, result);
//        if(result.hasErrors()) {
